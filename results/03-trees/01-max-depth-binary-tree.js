 ...
 *
 * Estrategia:
 * - La profundidad de un árbol es 1 + max(profundidad del hijo izquierdo, profundidad del hijo derecho)
 * - Caso base: si el nodo es null, retorna 0
 * - Usamos recursión para explorar todos los caminos desde la raíz hasta las hojas
 *
...
function maxDepth(root) {
  ...
  // Caso recursivo: profundidad = 1 + máximo de las profundidades de los subárboles
...
/**
 * Solución alternativa: BFS (Iterativa)
 * Útil para árboles muy profundos para evitar stack overflow
 */
function maxDepthBFS(root) {
  ...
  const queue = [[root, 1]]; // [nodo, profundidad]
  let maxDepthValue = 0;
